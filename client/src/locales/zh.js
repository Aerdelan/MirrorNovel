export default {
 ...
 novelDetail: {
  ...
  blueprintTitle: "三级动态故事蓝图",
  blueprintHint: "全书篇章、小阶段与未来 10–20 章执行卡；AI 调整仍需确认后才生效",
  ...
  blueprintRemindEvery6: "在滚动窗口与阶段边界提醒审核",
 ...
 common: { requestTimeout: "AI 服务长时间没有响应（连接可能已中断），请重试或更换线路", requestFailed: "请求失败，请稍后重试", invalidEncoding: "模型线路返回了损坏的文字编码，已阻止乱码进入作品。请重试；若仍出现，请更换模型线路", confirm: '确定', cancel: '取消', save: '保存', delete: '删除', edit: '编辑', close: '关闭', loading: '加载中...', yes: '是', no: '否', all: '全部' },
 ...
 // 写作人格 persona
 stepPersona: '选择写作风格',
 personaDesc: '默认跟随题材与细分标签自动定调；只有主动选择模板时才覆盖作者声线',
 personaAuto: '跟随题材与标签',
 personaAutoDesc: '由大类、题材、人设、基调与关系向共同决定风格，避免被通用网文模板覆盖',
 personaRecommended: '推荐',
 personaManage: '管理 / 新建',
 personaManageTitle: '写作风格管理',
 personaSys: '系统',
 // 整本生成：初始蓝图区
 blueprintTitle: '三级故事蓝图',
 blueprintDesc: '先确认全书大篇章、篇章内小阶段和未来 10–20 章执行卡。标签、人物声线、场景、关系变化和伏笔会直接约束章节生成。',
 ...
 blueprintEditHint: '可直接编辑蓝图文字；请保留段落标题和阶段章节范围',
 blueprintTextPlaceholder: '蓝图生成后会以可读文本显示在这里',
 blueprintTextMainArc: '故事主线',
 blueprintTextLockedFacts: '不可改写的设定',
 blueprintTextTagChecklist: '全书标签清单',
 blueprintTextPhases: '全书级篇章',
 blueprintTextPhase: '大篇章',
 blueprintTextSubphase: '小阶段',
 blueprintTextRolling: '滚动执行蓝图',
 blueprintTextRollingChapter: '执行章',
 blueprintTextChapterRange: '第 {start}-{end} 章',
 blueprintTextGoal: '阶段目标',
 blueprintTextObstacle: '主要阻力',
 blueprintTextReversal: '关键反转',
 blueprintTextThreads: '支线与人物关系',
 blueprintTextTags: '标签兑现',
 blueprintTextCharacters: '人物推进与声线',
 blueprintTextScenes: '必备场景',
 blueprintTextForbidden: '禁止漂移',
 blueprintTextEntry: '进入条件',
 blueprintTextExit: '离开条件',
 blueprintTextForeshadowing: '伏笔计划',
 blueprintTextUnresolved: '未决问题',
 blueprintTextWindowObjective: '窗口目标',
 blueprintTextChapterPurpose: '章节目的',
 blueprintTextRelationship: '关系变化',
 blueprintTextForeshadowingActions: '伏笔动作',
 blueprintTextExitHook: '章末钩子',
 blueprintTextCharacter: '角色',
 blueprintTextConflict: '冲突',
 blueprintTextChange: '变化',
 blueprintTextVoice: '声线',
 blueprintTextSetup: '埋设',
 blueprintTextProgress: '推进',
 blueprintTextPayoff: '回收',
 blueprintTextPlan: '安排',
 blueprintTextNone: '暂无',
 blueprintTextUntitled: '未命名阶段',
 // 字数设置
 ...
 thinkingCharsSuffix: '（已思考 {n} 字）',
  // 生成过程的状态/提示/弹窗（本次补齐）
   ...
   errBlueprintMainArc: "请保留“故事主线”段落",
 ...
 researchToggle: '联网取材', researchToggleDesc: '创建时自动检索题材相关的公开资料并抓取下方链接，用于补充时代背景与专业细节（未配搜索密钥时仍会抓取你粘贴的链接）',
 researchLinksLabel: '参考链接（每行一个，可选）', researchLinksPlaceholder: '粘贴需要参考的网页链接，每行一个，例如：\nhttps://example.com/history',
 researchStatus: { start: '🔎 正在联网取材…', done: ' 联网取材完成，参考 {n} 个来源', skipped: 'ℹ️ 本次未获取到联网资料，继续创作' },
