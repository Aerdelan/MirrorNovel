import json
# 从参考项目获取的字体映射（Python dict，key为十进制码点）
FONT_MAP = {
    ...
    '58665': '无', '58652': '情', '58676': '己', '58456': '面', '58581': '最', '58509': '女',
    ...
    '58587': '受', '58548': '听', '58351': '表', '58547': '德', '58443': '少', '58460': '克',
    ...
    '58582': '笑', '58534': '内', '58701': '英', '58349': '军', '58491': '候', '58467': '民',
...
# 转换为 key 为实际 PUA 字符（从十进制码点转换）
result = {}
for dec_str, char in FONT_MAP.items():
    code_point = int(dec_str)  # 十进制转整数
    if 0xE000 <= code_point <= 0xF8FF:
        pua_char = chr(code_point)  # 转为实际 PUA 字符
        result[pua_char] = char

with open('font_mapping.json', 'w', encoding='utf-8') as f:
    json.dump(result, f, ensure_ascii=False, indent=2)

print(f"转换完成: {len(result)} 个映射")
